      ...
      >
        ...
        >
          <div className="space-y-2">
            ...
            >
              <div
                className={`p-3 rounded-2xl bg-gradient-to-br ${typeConfig.gradient} shadow-xl`}
              >
          ...
          >
            ...
            >
              ...
              />
              Refresh
              <span className="hidden sm:inline ml-1 text-xs text-white group-hover:text-primary">
                (Ctrl+R)
              </span>
            </Button>
