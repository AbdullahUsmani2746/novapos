  ...
  return (
    <>
      ...
      <Input
        ...
        onChange={e => updateNestedSetting("email.subjectTemplate", e.target.value)}
      />
    </div>
    <div>
      ...
      <textarea 
        ...
        onChange={e => updateNestedSetting("email.textTemplate", e.target.value)}
      />
    </div>
    <div>
      ...
      <textarea
        ...
        onChange={e => updateNestedSetting("email.htmlTemplate", e.target.value)}
      />
    </div>
    <div>
      ...
      <textarea
        ...
        onChange={e => updateNestedSetting("email.pdfTemplate", e.target.value)}
      />
    </div>
