        ...
        <div className="bg-primary px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white mt-1">Fill in the information below</p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="border-t border-gray-200 bg-gray-50/50 px-8 py-4">
            <div className="flex justify-end space-x-4">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="px-8 py-3 rounded-xl bg-primary text-white font-semibold transition-all duration-30 hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl flex items-center space-x-2"
              >
                {isSubmitting ? (
                  <>
