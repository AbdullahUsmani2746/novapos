    ...
    lineFields: [
      {
        ...
        type: "select",
        options: "accounts",
        apiEndpoint: "/api/accounts/acno?macno=069",
        createEndpoint: "/api/accounts/acno",
        nameKey: "acname",
        valueKey: "acno",
        modalFields: [
  ...
  receipt: {
    ...
    masterFields: [
      ...
      { name: "time", label: "Time", type: "time", required: true },
      {
        ...
        type: "select",
        options: "accounts",
        apiEndpoint: "/api/accounts/acno?macno=039",
        createEndpoint: "/api/accounts/acno",
        nameKey: "acname",
        valueKey: "acno",
        required: true,
  ...
  purchase: {
    ...
    masterFields: [
      { name: "dateD", label: "Date", type: "date", required: true },
      {
        ...
        type: "select",
        options: "suppliers",
        apiEndpoint: "/api/setup/suppliers",
        createEndpoint: "/api/setup/suppliers",
        nameKey: "name",
        valueKey: "id",
        modalFields: [
    ...
    lineFields: [
      ...
      },
      {
        ...
        type: "select",
        options: "products",
        apiEndpoint: "/api/setup/products",
        createEndpoint: "/api/setup/products",
        nameKey: "name",
        valueKey: "id",
        modalFields: [
      ...
      { name: "qty_per_pack", label: "Qty Per Pack", type: "number" },
      {
        ...
        calculate: (v) => v.packs * v.qty_per_pack,
      },
  ...
  sale: {
    ...
    masterFields: [
      { name: "dateD", label: "Date", type: "date", required: true },
      {
        ...
        type: "select",
        options: "customers",
        apiEndpoint: "/api/setup/customers",
        createEndpoint: "/api/setup/customers",
        nameKey: "name",
        valueKey: "id",
        modalFields: [
