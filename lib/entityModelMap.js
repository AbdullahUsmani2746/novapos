...
const entityModelMap = {
  ...
  employees: {
    ...
    fields: (body) => ({
      ...
      status: body.status || "ACTIVE", // default agar form me na mile
      hireDate: new Date(body.hireDate),
      jobTitleId: parseInt(body.jobTitleId),
      departmentId: parseInt(body.departmentId),
      workLocationId: parseInt(body.workLocationId),
      ...
      costCenterId: parseInt(body.costCenterId),
    }),
  },
